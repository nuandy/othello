...
public class Terms extends AbstractControllerImpl {

  private static Logger logger = Logger.getLogger(Terms.class);

  public void doMain(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
      super.forward("app/views/terms.jsp", request, response);
  }
